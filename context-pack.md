...
> Generated by CodeAtlas at 2026-08-28T01:47:18.243Z
...
### packages/token-counter/package.json (23% relevance, full)

**Reasons:**

- Full-text search match (lexical: 50%)
- File path contains query terms (path: 50%)
- Located in relevant module boundary (module: 50%)
...
### packages/token-counter/src/index.ts (23% relevance, full)
...
### packages/token-counter/src/token-counter.ts (23% relevance, full)
...
### packages/token-counter/src/**tests**/token-counter.test.ts (23% relevance, full)
...
### packages/token-counter/tsconfig.json (23% relevance, full)
...
### packages/token-counter/tsup.config.ts (23% relevance, full)
...
### apps/cli/package.json (13% relevance, full)
...
### apps/cli/src/commands/context.ts (13% relevance, full)
...
### apps/cli/src/commands/export.ts (13% relevance, full)
...
### apps/cli/src/utils.ts (13% relevance, full)
...
### packages/context/package.json (13% relevance, full)
...
### packages/context/src/context-engine.ts (13% relevance, full)
...
### packages/context/src/**tests**/context.test.ts (13% relevance, full)
...
### packages/core/src/config.ts (13% relevance, full)
...
### packages/core/src/**tests**/core.test.ts (13% relevance, full)
...
### packages/exporters/src/exporters.ts (13% relevance, full)
...
### packages/indexer/src/**tests**/indexer.test.ts (13% relevance, signature)
...
### README.md (13% relevance, signature)
